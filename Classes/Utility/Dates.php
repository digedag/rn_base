...
class Dates
{
    ...
    public static function datetime_mysql2tstamp($datetime, $timezone = 'CET')
    {
        ...
        list($jahr, $monat, $tag) = Strings::intExplode('-', $datum);
        list($std, $min, $sec) = $zeit ? Strings::intExplode(':', $zeit) : [0, 0, 0];
    ...
    {
        if (0 === ($jahr + $monat + $tag + $std + $min + $sec)) {
            return 0;
        }
